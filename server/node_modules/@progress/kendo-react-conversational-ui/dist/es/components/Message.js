...
var Message = /** @class */ (function (_super) {
    ...
    Message.prototype.getTimestampView = function () {
        ...
        if (this.props.item.timestamp) {
            result = (React.createElement("time", { className: "k-message-time", "aria-hidden": !this.props.selected }, provideIntlService(this).formatDate(this.props.item.timestamp, 'g')));
        }
        return result;
    };
