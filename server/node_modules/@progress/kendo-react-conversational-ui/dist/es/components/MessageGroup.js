...
var MessageGroup = /** @class */ (function (_super) {
    ...
    MessageGroup.prototype.getGroupMessagesView = function () {
        ...
        return this.props.group.messages.map(function (msg, index) {
            var result = [(React.createElement(Message, { item: msg, template: _this.props.itemTemplate, selected: msg.selectionIndex === _this.props.selectedItemIndex, onRequestSelection: _this.props.onRequestSelection, tabbable: index === lastItemIndex && _this.props.isLastGroup, isFirstItemInGroup: index === 0, isLastItemInGroup: index === lastItemIndex, isOnlyItemInGroup: lastItemIndex === 0, key: index }))];
