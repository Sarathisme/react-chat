...
var SelectableItemsContainer = /** @class */ (function (_super) {
    ...
    function SelectableItemsContainer() {
        ...
        _this.onKeyDown = function (event) {
            ...
            var decrementKeyCode = _this.state.isKeyboardNavigationLeftRight ? Keys.left : Keys.up;
            var incrementKeyCode = _this.state.isKeyboardNavigationLeftRight ? Keys.right : Keys.down;
