...
var Chat = /** @class */ (function (_super) {
    ...
    function Chat(props) {
        ...
        _this.onBlur = function () {
            ...
            _this.timeoutIdForChatLosingFocus = setTimeout(function () { _this.setState({ selectedItemIndex: null }); }, 0);
        };
        ...
        _this.onKeyDown = function (event) {
            ...
            var currentSelectedItemIndex = _this.state.selectedItemIndex !== null ?
                ...
                _this.state.viewItems.lastSelectionIndex;
            if (event.keyCode === kendo_react_common_1.Keys.up) {
                ...
                else if (currentSelectedItemIndex < _this.state.viewItems.lastSelectionIndex) {
                    newSelectedItemIndex = currentSelectedItemIndex + 1;
                }
            }
        ...
        var viewItems = _this.getViewItemsFromMsgs(props.messages);
        _this.state = {
            viewItems: viewItems,
            selectedItemIndex: null,
            isDirectionRightToLeft: null
        };
        return _this;
    }
    /**
    ...
    Chat.prototype.render = function () {
        ...
        return (React.createElement("div", { style: { width: this.props.width }, onKeyDown: this.onKeyDown, className: this.getClassNames(), ref: function (el) { return _this.chatWrapperEl = el; } },
            React.createElement("div", { className: "k-message-list k-avatars", onBlur: this.onBlur, onFocus: this.onFocus, role: "log", "aria-live": "polite", ref: function (el) { return _this.viewItemsWrapperEl = el; } },
                React.createElement("div", { className: "k-message-list-content" }, this.renderViewItems())),
            React.createElement(NewMessage_1.default, { user: this.props.user, onMessageSend: this.onMessageSend, isDirectionRightToLeft: this.state.isDirectionRightToLeft, ref: function (comp) { return _this.newMsgComp = comp; }, placeholder: this.props.placeholder })));
    };
    /**
     * @hidden
     */
    Chat.prototype.componentWillReceiveProps = function (nextProps) {
        this.setState({
            viewItems: this.getViewItemsFromMsgs(nextProps.messages),
            isDirectionRightToLeft: this.checkIsDirectionRightToLeft(nextProps)
        });
    };
    /**
     * @hidden
    ...
    Chat.prototype.componentDidMount = function () {
        var _this = this;
        this.setState({ isDirectionRightToLeft: this.checkIsDirectionRightToLeft(this.props) }, function () {
            // W/o setTimeout the scrolling does not manage to go to the bottom, some offset is left.
            _this.nextTickId = setTimeout(function () { return _this.scrollViewItemsToBottom(); }, 250);
        });
    };
    /**
     * @hidden
    ...
    Chat.prototype.getClassNames = function () {
        return kendo_react_common_1.classNames('k-widget', 'k-chat', { 'k-rtl': this.state.isDirectionRightToLeft === true });
    };
    Chat.prototype.checkIsDirectionRightToLeft = function (props) {
        return props.dir !== undefined ? props.dir === 'rtl' :
            (this.chatWrapperEl && (getComputedStyle(this.chatWrapperEl).direction === 'rtl') || false);
    };
    Chat.prototype.selectLastViewItemWhenNoCurrentSelection = function () {
        if (this.state.selectedItemIndex === null) {
            this.setState({ selectedItemIndex: this.state.viewItems.lastSelectionIndex });
        }
    };
    Chat.prototype.renderViewItems = function () {
        var _this = this;
        var lastViewItemIndex = this.state.viewItems.length - 1;
